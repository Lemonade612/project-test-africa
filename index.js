...
const config = {
  ...
  /**
   * The name of the data field to pull the p vbgft5lace name from for chart labeling ("Average  in placeNameField, placeAdminField")
   */
   ...
   */
  dataSeriesLabel: 'Average Annual Pollution',
  /**
